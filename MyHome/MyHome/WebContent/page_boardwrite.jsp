       ...
       <form method=post action="boardin.jsp">
           ...
           <colgroup>
            ...
            <col />
             ...
             <tbody>
             <tr>
               <th class="emdfhr" colspan="2" >게시글 작성</th>
             </tr>
             <tr>
                <th class="titleth" >제목</th>
                <td><input class="title" type="text" name="up_title" id = "up_title"></td>
             </tr>
              <tr>
                <th class="titleth" >이름</th>
                <td><p><%= session.getAttribute("ID") %></p></td>
             </tr>          
             <tr>
                <th class="contentth" >내용</th>
                <td><textarea class="content" name="up_content" id = "up_content"></textarea></td>
             </tr>
             </tbody>
           </table>
           <div class="btndiv" >
              <input class="btn" type=button value="취소" OnClick="window.location='page_board.jsp'">
              <input class="btn" type=submit value="등록" style = "margin-right:2%">
           </div>
       </form>
    </div>
	</article>	
